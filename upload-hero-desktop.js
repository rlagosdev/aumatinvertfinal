...
async function uploadVideo() {
  console.log('📹 Upload de la vidéo hero desktop (16:9)...\n');

  try {
    // Lire le fichier vidéo
    const videoPath = 'C:\\Users\\rlago\\Downloads\\hero_video_desktop.mp4';
    const videoBuffer = fs.readFileSync(videoPath);
    const fileName = `video-desktop-${Date.now()}.mp4`;
    ...
    // Mettre à jour le paramètre hero_video_url_desktop dans site_settings
    ...
    const { error: updateError } = await supabase
      ...
      .upsert({
        ...
        description: 'URL de la vidéo hero pour desktop (16:9)'
      });
    ...
    console.log('\n🎉 Terminé ! Rechargez votre site desktop pour voir la nouvelle vidéo.');
    console.log('   La vidéo est au format 16:9 (1920x1080) sans bandes noires.');
